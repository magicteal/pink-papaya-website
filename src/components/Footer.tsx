      ...
      <Container>
        ...
        <div className="grid grid-cols-1 gap-8 pb-12 md:grid-cols-12 md:gap-10">
          ...
          <div className="md:col-span-6">
            <h3 className="mb-4 text-sm font-semibold uppercase tracking-wide text-neutral-600 text-center">
              Quick Links
            </h3>
            <ul className="grid grid-cols-2 gap-2 text-sm place-items-center">
              <li>
              ...
              <li>
                <Link className="hover:underline" href="/stays">
                  Stays
                </Link>
              </li>
              <li>
                <Link className="hover:underline" href="/interior">
                  Interior
                </Link>
              </li>
              <li>
          ...
          <div className="md:col-span-6">
            ...
            <p className="mb-4 text-sm text-neutral-600">
              Small updates on rooms, offers, and little stories from Pink
              Papaya. No spam.
            </p>
        ...
        <div className="flex items-center justify-center py-6 text-xs text-neutral-500">
          © {new Date().getFullYear()} Pink Papaya — All rights reserved.
        </div>
      </Container>
    </footer>
  );
